...
<div class="container">
	<form action="norProductWrite.do" method="post" style="margin-left: 420px; margin-top: 20px; margin-bottom: 10px;">
			<!-- 파일업로드를 위해 추가하는 타입 -->
	...
	<tr>
			...
			<tr>
				...
				<td><textarea id="priceText" name="priceText" style="resize: none;width: 306px;height: 176px;"></textarea></td>
			</tr>
		</table>
		<div class="filebox">
			<table>
				...
				<input class="upload-name" value="파일선택" disabled="disabled" multiple/>
