...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-re	set/2.0/reset.min.css" />
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
<style>

.chat_wrap{border:1px solid #999; width:300px; padding:5px; font-size:13px; color:#333}
.chat_wrap .inner{background-color:tomato; border-radius:5px; padding:10px; overflow-y:scroll; height:400px; background-image: url("../img/logo_hammer.png");background-size: 200px; background-repeat: no-repeat;}
...
input[type="text"]{border:0; align:right; width:88%; background:#ddd; border-radius:5px; height:30px; padding-left:5px; box-sizing:border-box; margin-top:5px; margin-left:35px;}
...
<body>
	...
	<ul>
		...
		<select id="" <label for=""></label> name="job" size="1">
			<option value="">선택하세요.</option>
			<option value="사진 전송"><a href="#"></a></option>
			<option value="동연상 전송">동영상</option>
			<option value="카메라 촬영">카메라 촬영</option>
			<option value="음성 메시지">음성 메시지</option>
			<option value="위치 전송">위치 전송</option>
