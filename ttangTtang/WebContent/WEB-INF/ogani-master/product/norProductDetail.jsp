		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					<c:forEach var="norProduct" items="${norPro}">
						<h2>${norProduct.cname}</h2>
						<div class="breadcrumb__option">
							<a href="/ttangTtang/ogani-master/index.jsp">Home</a> <span>일반판매</span>
						</div>
					</c:forEach>
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-6">
				<c:forEach var="norProduct" items="${norPro}">
					<div class="product__details__text">
						<h3>${norProduct.iname }</h3>

						<div class="product__details__price">가격</div>
						<p>${norProduct.pricetext}</p>
						...
						<ul>
							<li><b>판매자</b><span>${norProduct.userid}</span></li>
							<li><b>공유</b>
								<div class="share">
