	...
	<div class="container" style="padding-left: 34%;">
		<form id="norForm" name="norForm" action="productModify.do"
			...
			<table>
				<tr>
					<td>상품명:</td>
					<td><span><input type="text" name="productNameNor" value="${norPro.iname}"></span></td>
				</tr>
				<tr>
					<td>카테고리:</td>
			...
			<table>
				<tr>
					<td><span style="opacity: 0.6; font-size: 12px;">(최대
							10개의 이미지를 선택하실 수 있습니다.※정면,측면,후면 필수!)</span></td>
				</tr>
				<tr>
					<td>
						<div id="previewNor" class="preview" value="${norPro.imageface}"></div>
	...
	<div class="container" style="padding-left: 34%;">
		<form id="aucForm" name="aucForm" action="productModify.do"
			...
			<table>
				<tr>
					<td>상품명:</td>
					<td colspan="2"><input type="text" name="productNameAuc" value="${aucPro.iname}"></td>
				</tr>
				<tr>
					<td>카테고리:</td>
				...
				<tr>
					...
					<td><select name="endTime" value="${aucPro.endtime}">
