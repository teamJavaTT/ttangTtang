...
<script>
	...
	function product_write() {
		...
		document.form1.cCode.value = cCode;
...
<section>
	...
	<div class="container">
		<form action="aucProductWrite.do" method="post" style="margin-left: 420px; margin-top: 20px; margin-bottom: 10px;">
			<!-- 파일업로드를 위해 추가하는 타입 -->
				...
				<table>
					...
					<tr>
						<td>
							...
							<input type="file" name="imageface" id="ex_filename" class="upload-hidden"></td>
					</tr>
					<tr>

						<td colspan="2" align="center">
							<input type="submit" value="등록"> <!-- "등록" 버튼을 누르면 위쪽에 있는 스크립트문에서 product_write()함수가 호출되서 실행되 insert.do페이지로 자료를 전송한다. -->
							<input type="button" value="목록" onclick="location.href='${path}/../index.do'"> <!-- "목록 버튼을 누르면 list.do페이지로 이동" -->
						</td>
					</tr>
				</table>
			</div>
