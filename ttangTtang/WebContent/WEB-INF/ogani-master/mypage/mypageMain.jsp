...
<div class="col-lg-9">
	                ...
	                <div style="text-align : center;margin-bottom: 100px;">
	                	...
	                	<a href="memberEdit.do"><button type="submit" id="btnJoin">회원정보 수정</button></a>
						<a href="sellcheck.do"><button type="submit" id="btnJoin">내 판매 내역</button></a>
						...
						<a href="adminmain.do"><button type="submit" id="btnJoin">고객 센터</button></a>
						<a href="deleteForm.do"><button type="submit" id="btnJoin">회원탈퇴</button></a>
						
						
						
	                	<a href="deleteForm.do"><button type="submit" id="btnJoin">관심 상품</button></a>
