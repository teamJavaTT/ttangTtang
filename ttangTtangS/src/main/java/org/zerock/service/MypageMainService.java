...
public interface MypageMainService {
	...
	List<AccountDeclaration> selectAccountDeclaration(@Param("userid") String userid, @Param("accountDeclaration")  String accountDeclaration, int pageStart,
			int pageEnd) throws Exception;
}
