...
public interface MypageMainService {
	...
	int selectLikeProductListCount() throws Exception;
	...
	List<BlockUser> selectBlockUser(@Param("userid") String userid, @Param("blockUser1") String blockUser1, int pageStart, int pageEnd) throws Exception;

	List<AccountDeclaration> selectAccountDeclaration(@Param("userid") String userid, @Param("accountDeclaration") String accountDeclaration, int pageStart, int pageEnd) throws Exception;
