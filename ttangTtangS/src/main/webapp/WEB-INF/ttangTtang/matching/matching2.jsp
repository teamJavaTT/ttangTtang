	...
	<div class="chat_wrap">
		...
		<ul>
			<form method="get" action="SelectServlet">
				...
				<select id="" <label for="">클릭</label> name="job"
					; url("../img/button_hammer.png")>

					<option value="사진 전송">사진<a href="../img/button_hammer.png"></a></option>
		...
		<tb> <input class="item mymsg" ; type="text" class
			placeholder="내용 입력">
	</div>
</body>
</html>
